		...
		<div class="container-fluid">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="/">
					<img class="nvbar-white img-responsive" src="<?php echo esc_html( get_field( 'general_options_logo', 'option' ) ); ?>" alt="">
					<img class="nvbar-blue img-responsive" src="<?php echo esc_html( get_field( 'general_options_logo_blue', 'option' ) ); ?>" alt="">
				</a>
				<div class="navbar-mobile-search">
					<form action="<?php echo esc_url( get_home_url() ); ?>" class="navbar-search">
						<span class="navbar-search__close" data-navbar-search-close>
							<?php use_icon( 'icon-close-menu-mobile', 'icon-close-menu-mobile' ); ?>
						</span>
						<input type="text" name="s" class="navbar-search__input" placeholder="Search...">
					...
					<a href="#" class="icon-search visible-xs" data-toggle-search>
						<svg width="24px" height="24px" viewBox="0 0 30 30" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
							<path d="M6,15.985258 C6,21.4938575 10.4815725,25.970516 15.985258,25.970516 C18.5208845,25.970516 20.8402948,25.017199 22.6044226,23.4545455 L28.968059,29.8181818 C29.0859951,29.9361179 29.2383292,29.995086 29.3955774,29.995086 C29.5528256,29.995086 29.7051597,29.9361179 29.8230958,29.8181818 C30.0589681,29.5823096 30.0589681,29.2039312 29.8230958,28.968059 L23.4545455,22.6044226 C25.017199,20.8402948 25.970516,18.5257985 25.970516,15.985258 C25.970516,10.4766585 21.4889435,6 15.985258,6 C10.4815725,6 6,10.4766585 6,15.985258 Z M24.7665848,15.985258 C24.7665848,20.8255528 20.8255528,24.7665848 15.985258,24.7665848 C11.1449631,24.7665848 7.2039312,20.8255528 7.2039312,15.985258 C7.2039312,11.1449631 11.1449631,7.2039312 15.985258,7.2039312 C20.8255528,7.2039312 24.7665848,11.1400491 24.7665848,15.985258 Z"></path>
						</svg>
					</a>
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav nav-leftinfo">
					<li class="visible-md visible-lg call_us">
						<a href="#"><strong>
							<?php echo esc_html( get_field( 'contact_phone_cta', 'option' ) ); ?>
							<?php echo esc_html( get_field( 'contact_phone', 'option' ) ); ?>
						</strong></a>
					</li>
					<li class="btn-login hidden-sm">
						<a target="_blank"
				...
				<ul class="nav navbar-nav navbar-right nav-rightinfo">

					<?php
					if (is_page_template( 'page-templates/egg-hunt.php' )) {
						wp_nav_menu( array(
							'theme_location' => 'egg_hunt',
						));
					} else {
						wp_nav_menu( array(
                    ...
                    <ul>
						<li class="navbar-search-item">
							...
							<a href="#" class="icon-search" data-toggle-search>
						...
						<li>
							<a href="#" id="more_" class="extramenu-open">More + </a>
						</li>
					</ul>
					<?php endif; ?>
				</ul>
