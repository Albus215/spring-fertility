...
// complex tasks
gulp.task( 'build', gulp.series(['styles:build', 'js:build', 'icons']) );
gulp.task( 'watch', gulp.series(['js', 'js:watch', 'styles', 'styles:watch']) );
gulp.task( 'lint', gulp.series(['styles:lint', 'js:lint']) );


// General Configurations
// Directories where JS and SCSS is placed.
const appDirectories = [ 'atoms', 'molecules', 'organisms', 'templates', 'utils' ];
